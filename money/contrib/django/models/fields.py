...
def currency_field_db_column(amount_field_name, db_column):
    return "%s_currency" % (db_column if db_column is not None else amount_field_name)
    ...
    def contribute_to_class(self, cls, name):
        ...
        if self.add_currency_field and not cls._meta.abstract:
            c_field = CurrencyField(
                ...
                db_column=currency_field_db_column(self.amount_field_name, self.db_column),
            )
